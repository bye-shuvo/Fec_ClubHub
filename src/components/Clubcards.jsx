...
const Clubcards = ({ clubs, getCategoryColors, isFetching }) => {
  return (
    <div
      id="club-cards"
    ...
    >
      ...
      <div className="text-center md:mb-12 mb-6">
        <h2 className="font-header md:text-6xl text-4xl font-bold text-text dark:text-white md:mb-4 mb-3">
          Our Clubs
        </h2>
              ...
              return (
                ...
                >
                  ...
                  <div className="md:p-6 p-4">
                    <h3
                      className={`md:text-xl text-lg font-bold text-text dark:text-white mb-3 group-hover:${colors.text} transition-colors duration-300`}
                    >
                      {club.name}
                    </h3>
